...
function CaterContactDashBoard() {
                ...
                <div className="row ">
                    <div className="col-md-3 col-lg-2  asidebar">
                        ...
                        <div>
                            ...
                            <li><Link to="/Dashboard1" className='textnone'><strong style={{color:"black"}}><RxDashboard /></strong><span style={{color:"black"}}>Profile</span></Link></li>
                    ...
                    <div className="col content text-center boxborder">
                        <div>
                            <h1 className='ml-5'>Contact DashBoard</h1>
...
export default CaterContactDashBoard;
