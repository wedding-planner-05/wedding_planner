...
export default function ResetPassword() {
  ...
  // console.log(vendorType+" vendor Type");
    ...
    // const vendorType=getItem("current-user",user);

    const resetpassword = () => {

        if (validatePassword()) {
            if (newpassword === confirmpassword) {
                axios.post(`http://localhost:3000/${vendorType}/${vendorType}/`, { newpassword })
                    .then(() => {
                        Swal.fire({
                            position: "center",
                            icon: "success",
        ...
        <div className='container-fluid m-0 p-0' style={{ maxWidth: "100%", height: "100vh", backgroundColor: "#ececec" }}>
            ...
            <div className="container d-flex justify-content-center align-items-start min-vh-100" style={{ backgroundColor: "#ececec" }}>
                <div className="row border rounded-5 p-3 bg-white shadow box-area mt-5">
                    <div className="col-md-6 p-0 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style={{ background: "crimson" }}>
                        <div className="featured-image">
                            <img src="images/About-us.webp" className="rounded-4" style={{ width: "500px",height:"500px" }} />
                        </div>
                        <p className="text-white fs-2 mt-3 text" style={{ fontWeight: "600" }}>Be Verified</p>
                        <small className="text-white text-wrap text-center text" style={{ width: "17rem" }}>Join experienced  Wedding Planner on this platform.</small>
                    </div>
                    <div className="col-md-6 right-box">
                        <div className="row align-items-center">
                            <div className="header-text mb-4">
                                <h2>Welcome,</h2>
                                <p className="ms-2">Recover Your <span className="text-primary fw-bold">Wedding Planner</span> Account</p>
                            </div>
